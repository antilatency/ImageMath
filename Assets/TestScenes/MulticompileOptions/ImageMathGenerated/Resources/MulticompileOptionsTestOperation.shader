Shader "MulticompileOptionsTestOperation"{
    Properties {}
    SubShader {
        ...
        #pragma multi_compile_local Color_Red Color_Green Color_Blue
        #pragma multi_compile_local _ DrawCircle
        ...
        float4 frag(VSO input) : SV_Target {
            #include "D:\ImageMath\Assets\TestScenes\MulticompileOptions\MulticompileOptionsTestOperation.FragmentShaderBody.cginc"
        }
