Shader "TestOperation"{
    ...
    SubShader {
        ...
        int ImageMath_I0;
        #define IntValue1 ImageMath_I0
        int ImageMath_I1;
        #define IntValue2 ImageMath_I1
        float3 ImageMath_V3;
        #define VectorValue1 ImageMath_V3
        float3 ImageMath_V4;
        #define VectorValue2 ImageMath_V4
        float3 ImageMath_V2;
        #define VectorValue0 ImageMath_V2
        float2 ImageMath_V0;
