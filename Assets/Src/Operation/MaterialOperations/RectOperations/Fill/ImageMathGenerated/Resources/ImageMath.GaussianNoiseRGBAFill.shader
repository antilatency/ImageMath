Shader "ImageMath/GaussianNoiseRGBAFill"{
    Properties {}
    SubShader {
        ...
        #include "D:\ImageMath\Assets\Src\Operation\MaterialOperations\RectOperations\Fill\Noise.cginc"
        ...
        float4 frag(VSO input) : SV_Target {
            return Amplitude * GaussianNoiseRGBA(input.uv);
        }
