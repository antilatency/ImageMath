Shader "ImageMath/UnpackBlackmagicDesignFilmGen5"{
    Properties {}
    SubShader {
        ...
        float4 frag(VSO input) : SV_Target {
            ...
            static const float iA = 0.120720378448513;
            static const float B = 0.09246575;
            static const float C = 0.005494073;
            static const float iD = 11.5036723322912;
            static const float E = 0.5300133;
            static const float Breakpoint = 0.1338838;
