Shader "ImageMath/LUT2DTransform"{
    ...
    SubShader {
        ...
        float4 frag(VSO input) : SV_Target {
            ...
            #include "D:\ImageMath\Assets\Src\Operation\MaterialOperations\RectOperations\TextureOperation\ColorTransformOperation\LUTs\LUT2DTransform.ColorTransform.cginc"
        }
