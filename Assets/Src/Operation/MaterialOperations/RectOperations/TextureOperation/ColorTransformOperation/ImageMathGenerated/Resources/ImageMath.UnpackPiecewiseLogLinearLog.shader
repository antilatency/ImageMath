Shader "ImageMath/UnpackPiecewiseLogLinearLog"{
    Properties {}
    SubShader {
        ...
        float InvLeftThreshold;
        float InvRightThreshold;
        float InvLinearScale;
        float InvLinearOffset;
        float InvLeftExpInnerScale;
        float InvLeftExpInnerOffset;
        float InvLeftExpOuterScale;
        float InvLeftExpOuterOffset;
        float InvRightExpInnerScale;
        float InvRightExpInnerOffset;
        float InvRightExpOuterScale;
        float InvRightExpOuterOffset;
