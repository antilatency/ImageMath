Shader "ImageMath/UnpackPiecewiseLinearPow"{
    Properties {}
    SubShader {
        ...
        float InvPowInnerScale;
        float InvPowInnerOffset;
        float InvPowExponent;
        float InvPowOuterScale;
        float InvPowOuterOffset;
