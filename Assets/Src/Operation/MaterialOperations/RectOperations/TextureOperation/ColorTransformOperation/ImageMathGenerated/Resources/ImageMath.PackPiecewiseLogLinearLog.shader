Shader "ImageMath/PackPiecewiseLogLinearLog"{
    Properties {}
    SubShader {
        ...
        float LeftLogInnerScale;
        float LeftLogInnerOffset;
        float LeftLogOuterScale;
        float LeftLogOuterOffset;
        float LinearScale;
        float LinearOffset;
        float RightLogInnerScale;
        float RightLogInnerOffset;
        float RightLogOuterScale;
        float RightLogOuterOffset;
