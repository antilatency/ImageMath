Shader "ImageMath/PixelRegion"{
    ...
    SubShader {
        ...
        #pragma multi_compile_local _ ClampPixelCoordinates
        ...
        float4 frag(VSO input) : SV_Target {
            #include "D:\ImageMath\Assets\Src\Operation\MaterialOperations\PixelRegion\PixelRegion.FragmentShaderBody.cginc"
        }
